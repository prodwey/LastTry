...
class SongManager: ObservableObject {
    ...
    private func getAudioDuration(url: URL) -> TimeInterval? {
        ...
        // Use the recommended method instead of the deprecated duration.seconds property
        if #available(iOS 16.0, *) {
            // For iOS 16 and later, use the new method
            do {
            ...
            // For iOS 15 and earlier, use the old method which is still available
